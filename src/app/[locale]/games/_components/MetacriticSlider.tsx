  ...
  return (
    <div>
      ...
      <div className="mb-3 flex items-center justify-between">
        <span className="badge badge-neutral font-bold tabular-nums">{min}</span>
        <span className="text-xs opacity-30">—</span>
        <span className="badge badge-primary font-bold tabular-nums">{max}</span>
      </div>
      <div className="relative flex h-6 items-center px-1">
        <div className="bg-base-300 relative h-1.5 w-full overflow-hidden rounded-full">
          <div
        ...
        <input
          ...
          className="range range-primary range-xs pointer-events-none absolute inset-x-0 h-1.5 w-full appearance-none bg-transparent [&::-moz-range-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:pointer-events-auto"
