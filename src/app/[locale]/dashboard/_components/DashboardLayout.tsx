...
const DashboardLayout = ({ children }: IDashboardLayoutProps) => {
  ...
  return (
    <Flex h="100vh" overflow="hidden" bg="gray.100" direction="row">
      <Box display={{ base: 'none', md: 'block' }} w="300px" bg="bg.panel" shadow="2xl" zIndex="10">
        <Sidebar />
      </Box>
      ...
      <Stack flex="1" gap="0" overflow="hidden">
        ...
        <Box as="main" py="8" flex="1" overflowY="auto" bg="gray.100">
